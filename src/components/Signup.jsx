...
//               className="bg-green-600 text-white py-3 px-4 text-xl rounded-xl font-semibold hover:bg-green-700 transition-colors w-[32rem]"
//             >
//               Continue
//             </button>
//           </div>
...
const SignupPage = () => {
  ...
  const handleContinueToCreatePin = () => {
    setSuccessModal(false); // Hide success modal
    setShowCreatePin(true); // Show CreatePin modal
  };
    ...
    <div className="h-screen bg-green-950 text-white flex flex-col items-center justify-center">
        ...
        <form className="space-y-4" onSubmit={handleSignup}>
          <div className="mb-4">
            ...
            <input
              ...
              placeholder={emailError ? "Email is required" : "Email"}
              className={`w-full p-3 bg-neutral-600 text-neutral-200 font-semibold text-lg border border-stone-900 rounded-lg focus:outline-none ${
                emailError ? "border-red-500 placeholder-red-500" : "focus:ring focus:ring-green-400"
              }`}
            />
          </div>
          ...
          <div className="mb-4 relative">
            ...
            <input
              ...
              id="password"
              className={`w-full p-3 bg-neutral-600 text-neutral-200 font-semibold text-lg border border-stone-900 rounded-lg focus:outline-none ${
                passwordError ? "placeholder-red-600 border-2 italic border-red-500" : ""
              }`}
              placeholder={passwordError || "Enter your password"}
            />
            <div
          ...
          <div className="mb-4">
            ...
            <input
              ...
              placeholder={nameError ? "User Name is required" : "User Name"}
              className={`w-full p-3 bg-neutral-600 text-neutral-200 font-semibold text-lg border border-stone-900 rounded-lg focus:outline-none ${
                nameError ? "border-red-500 placeholder-red-500" : "focus:ring focus:ring-green-400"
              }`}
            />
          </div>
          ...
          <button
            type="submit"
            className={`py-3 px-6 w-full rounded-lg text-lg font-bold ${
              isProceedDisabled || loading ? "bg-green-300 cursor-not-allowed" : "bg-green-500 hover:bg-green-600"
            } transition`}
            disabled={isProceedDisabled || loading}
          >
            {loading ? "Signing Up..." : "Sign Up"}
      ...
      {successModal && (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex flex-col items-center justify-center z-50">
          <div className="bg-black w-[38rem] flex flex-col items-center justify-center py-10 px-20 outline-none rounded-xl shadow-sm shadow-green-100 text-center">
            <Image src="/good.png" alt="Success Image" width={300} height={300} className="rounded-xl shadow-2xl" />
            <h2 className="text-5xl font-bold mb-4 text-white">Success!</h2>
            <p className="mb-4 text-2xl">You have signed up successfully.</p>
            <button
              onClick={handleContinueToCreatePin}
              className="bg-green-600 text-white py-3 px-4 text-xl rounded-xl font-semibold hover:bg-green-700 transition-colors w-[32rem]"
            >
              Create PIN
            </button>
      ...
      {showCreatePin && <CreatePin show={showCreatePin} onClose={() => setShowCreatePin(false)} />}
    </div>
  );
};
